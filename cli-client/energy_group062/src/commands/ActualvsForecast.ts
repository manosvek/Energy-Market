...
export default class ActualvsForecast extends Command {
    static description = 'displays actual vs forecasted total load for selected area, resolution and time'

    static examples = ['$ energy_group062 ActualvsForecast --area Greece --timeres PT60M --date 2018-01-15']
    ...
    async run() {
        ...
        var request = new String(`https://localhost:8765/energy/api/ActualvsForecast/${flags.area}/${flags.timeres}/`)
