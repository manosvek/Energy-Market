...
export default class DayAheadTotalLoadForecast extends Command {
    static description = 'displays day ahead total load forecast for selected area, resolution and time'
    ...
    async run() {
        ...
        var request = new String(`https://localhost:8765/energy/api/DayAheadTotalLoadForecast/${flags.area}/${flags.timeres}/`)
