...
CREATE TABLE AllocatedEICDetail (
  ...
  EntityModifiedAt                      timestamp(6) NOT NULL, 
  MRID                                  varchar(254), 
  DocStatusValue                        varchar(254), 
  AttributeInstanceComponent            varchar(254), 
  LongNames                             varchar(254), 
  DisplayNames                          varchar(254), 
  LastRequestDateAndOrTime              datetime(6) NULL, 
  DeactivateRequestDateAndOrTime        datetime(6) , 
  MarketParticipantStreetAddressCountry varchar(254), 
  MarketParticipantACERCode             varchar(254), 
  MarketParticipantVATcode              varchar(254), 
  Description                           varchar(255), 
  EICParentMarketDocumentMRID           varchar(254), 
  ELCResponsibleMarketParticipantMRID   varchar(254), 
  IsDeleted                             bit(8) NOT NULL,
  AllocatedEICID                        int(11), 
...
INSERT INTO Users VALUES ('admin', '321nimda', 0, 'pmisiakos@hotmail.com', true);

CREATE TABLE grammes (
  poses int(11) PRIMARY KEY
  
);

INSERT INTO grammes VALUES (14469);
